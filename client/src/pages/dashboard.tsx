...
import { Activity, TrendingUp, CheckCircle2, Percent, Settings as SettingsIcon } from "lucide-react";
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">Received from TradingView</p>
            </CardContent>
          </Card>
